...
// //         const nodes = cy.$(`node[type="${value}"]`);
// //         const edges = nodes.connectedEdges();
// //         const isVisible = nodes.css('visibility') === 'visible';
// //         nodes.css('visibility', isVisible ? 'hidden' : 'visible');
// //         edges.css('visibility', isVisible ? 'hidden' : 'visible');
// //         element.style.color = isVisible ? "#CCC" : "#555";
// //         element.dataset.clicked = isVisible ? "true" : "";
// //     }
// //     elements.forEach((element) => {
// //         element.addEventListener("click", function(){
...
//     $.each(data, (index, {id, group, label, occupation, country, scope, directive, projects, realm, eu_region, events}) => {
